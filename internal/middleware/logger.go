...
//Взято из статьи/репозитория Николая Тузова, с той разнцей, что на данный момент log/slog входит в стандартную библиотеку
//github.com/GolangLessons/url-shortener/blob/main/internal/http-server/middleware/logger/logger.go

func NewCustomSlogLogger(log *slog.Logger) func(next http.Handler) http.Handler {
